...
humandate: "Jan 27-31, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Christian Schudoma", "Christian Tischer", "Jacobo Miranda", "Jean-Karim Hériché", "Renato Alves"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Anastasiia Grekova", "Dominik Kutra", "Felix Schneider", "Francesco Tabaro", "Julian Hennies", "Lisanna Paladin", "Mahnoor Zulfiqar", "Sarah Kaspar", "Thomas Weber"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["renato.alves@embl.de","lisanna.paladin@embl.de", "christian.schudoma@embl.de"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
